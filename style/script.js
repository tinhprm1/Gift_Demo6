...
const fullText1 = splitLines("Xin Chào Yink", 3);
const fullText2 = splitLines("Mong Sao Em Luôn Hạnh Phúc Cười Tươi", 3);
const fullText3 = splitLines("Valentine Vui Vẻ Ạ", 3);
